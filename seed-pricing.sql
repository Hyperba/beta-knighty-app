...
-- Access (Basic)
insert into public.pricing_plans (tier, name, tagline, description, monthly_price, yearly_price, cta_label, showcase_image, is_popular, sort_order)
values ('access', 'Access', 'Unlock more', 'Step up with access-tier builds, complete build guides, and tutorials.', 8.99, 80.99, 'Get Access', '/builds/houses.png', false, 1)
on conflict (tier) do update set
  name = excluded.name, tagline = excluded.tagline, description = excluded.description,
  monthly_price = excluded.monthly_price, yearly_price = excluded.yearly_price,
  cta_label = excluded.cta_label, showcase_image = excluded.showcase_image,
...
-- Builder (Premium)
insert into public.pricing_plans (tier, name, tagline, description, monthly_price, yearly_price, cta_label, showcase_image, is_popular, sort_order)
values ('builder', 'Builder', 'For serious builders', 'Unlock builder-tier assets, high-quality build packs, and early access to new drops.', 14.99, 139.99, 'Get Builder', '/builds/portals.png', true, 2)
on conflict (tier) do update set
  name = excluded.name, tagline = excluded.tagline, description = excluded.description,
  monthly_price = excluded.monthly_price, yearly_price = excluded.yearly_price,
  cta_label = excluded.cta_label, showcase_image = excluded.showcase_image,
...
-- Architect (Ultimate)
insert into public.pricing_plans (tier, name, tagline, description, monthly_price, yearly_price, cta_label, showcase_image, is_popular, sort_order)
values ('architect', 'Architect', 'The full experience', 'Everything unlocked. Every build, every guide, priority support, exclusive content.', 34.99, 314.99, 'Get Architect', '/builds/vehicles.png', false, 3)
on conflict (tier) do update set
  name = excluded.name, tagline = excluded.tagline, description = excluded.description,
  monthly_price = excluded.monthly_price, yearly_price = excluded.yearly_price,
  cta_label = excluded.cta_label, showcase_image = excluded.showcase_image,
