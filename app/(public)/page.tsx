...
import { ChevronLeft, ChevronRight, ArrowRight, TrendingUp, Clock, Users, Star, Download, Zap, Crown, Sparkles, MessageSquare, Quote, Palette, Shield, Layers } from 'lucide-react'
...
export default function Landing() {
  ...
  const jsonLd = {
    ...
    '@type': 'Organization',
    name: 'KnightyBuilds',
    url: process.env.NEXT_PUBLIC_SITE_URL || 'https://knightybuilds.com',
    logo: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://knightybuilds.com'}/knighty.png`,
    description: 'Premium Minecraft builds, schematics, and world maps with step-by-step guides',
    sameAs: [
      'https://twitter.com/knightybuilds',
    ],
          ...
          <div className={`${styles.nextInner} ${styles.communityInner}`}>
            <div className={styles.communityLeft}>
              ...
              <h2 className={styles.communityTitle}>
                Premium Minecraft Builds. <span className={styles.gradientText}>Ready to Download</span>
              </h2>
              <p className={styles.communitySubtitle}>
                Download detailed, survival-ready builds and exclusive content you won&apos;t find anywhere else.
              </p>
                    ...
                    <Link key={build.id} href={`/builds/${build.slug}`} className={styles.freeBuildCard}>
                      <div className={styles.freeBuildImageWrap}>
                        {build.image_url ? (
                          ...
                          <div className={styles.freeBuildImagePlaceholder} />
                        )}
            ...
            <div className={styles.upgradeCard}>
              ...
              <div className={styles.upgradeContent}>
                ...
                <div className={styles.upgradePerks}>
                  ...
                  <div className={styles.upgradePerk}>
                    <Layers />
                    <span>3D Layer-by-Layer Guides</span>
                  </div>
                  <div className={styles.upgradePerk}>
                    <Layers />
                    <span>2D Layer-by-Layer Guides</span>
                  </div>
                </div>
      ...
      <section className={styles.nextSection}>
        <div className={`${styles.nextInner} ${styles.showcaseInner}`}>
          <div className={styles.showcaseHeader}>
            ...
            <h2 className={styles.showcaseTitle}>Signature Projects</h2>
            <p className={styles.showcaseSubtitle}>
              Our most detailed and ambitious builds, created for competitions, collaborations, and large-scale visions.
            </p>
          </div>
          ...
          <div className={styles.supportShell}>
            ...
            <div className={styles.perksBlock}>
              <h2 className={styles.perksHeading}>
                Gain These <span className={styles.perksAccent}>Awesome</span> Benefits
              </h2>
              ...
              <div className={styles.perksPills}>
                ...
                <div className={styles.perkPill}>
                  <span className={styles.perkIcon} />
                  <span className={styles.perkText}>3D layer-by-layer guides</span>
                </div>
                <div className={styles.perkPill}>
                  <span className={styles.perkIcon} />
                  <span className={styles.perkText}>2D layer-by-layer guides</span>
                </div>
              </div>
            </div>
          ...
          <div className={`${styles.nextInner} ${styles.testimonialsInner}`}>
            <div className={styles.testimonialsHeader}>
              ...
              <p className={styles.testimonialsSubtitle}>
                Reviews from builders who use KnightyBuilds
              </p>
