...
export default function Contact() {
  ...
  const handleDiscordCopy = useCallback(() => {
    navigator.clipboard.writeText('xKnighty').then(() => {
  ...
  return (
    <main className={styles.contact}>
      <div className={styles.heroSection}>
        ...
        <p className={styles.subtitle}>Have questions, feedback, or interested in a custom build? We'd love to hear from you. Reach out through the form or any of our channels below.</p>
      </div>
      ...
      <div className={styles.contentGrid}>
        <div className={styles.formSection}>
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.formGroup}>
              <label htmlFor="projectType" className={styles.label}>Inquiry Type *</label>
              <select
                id="projectType"
                name="projectType"
              ...
              >
                ...
                <option value="Build Support">Build Support</option>
        ...
        <div className={styles.socialSection}>
          ...
          <div className={styles.socialLinks}>
             <a
              href="https://instagram.com/knightybuilds"
              target="_blank"
            ...
            >
              ...
              <div className={styles.socialContent}>
                ...
                <p className={styles.socialLinkText}>@knightybuilds</p>
              </div>
            </a>
            <a
              href="mailto:knighty@knightybuilds.com"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
            >
            ...
            >
              ...
              <div className={styles.socialContent}>
                ...
                <p className={styles.socialLinkText}>{discordCopied ? 'Copied!' : 'xKnighty'}</p>
              </div>
            </div>

            <a
              href="https://youtube.com/@knightybuilds"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
            >
      ...
      <section id="review" className={styles.reviewSection}>
        <div className={styles.reviewHeader}>
          ...
          <p className={styles.reviewSubtitle}>
            Help others discover KnightyBuilds by sharing your experience
          </p>
        </div>
          ...
          <form onSubmit={handleReviewSubmit} className={styles.reviewForm}>
            ...
            <div className={styles.reviewFormGroup}>
              ...
              <textarea
                ...
                placeholder="Share your experience with KnightyBuilds. What did you like? How did it help your server or world?"
              />
