...
export const metadata: Metadata = {
  ...
  title: {
    default: 'KnightyBuilds - Premium Minecraft Builds & Schematic Downloads',
    template: '%s | KnightyBuilds',
  },
  ...
  authors: [{ name: 'KnightyBuilds' }],
  creator: 'KnightyBuilds',
  publisher: 'KnightyBuilds',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    ...
    locale: 'en_US',
    url: '/',
    siteName: 'KnightyBuilds',
    title: 'KnightyBuilds - Premium Minecraft Builds & Schematic Downloads',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'KnightyBuilds - Premium Minecraft Builds',
      },
    ],
  },
  twitter: {
