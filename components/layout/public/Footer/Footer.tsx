        ...
        <footer className={styles.footer}>
            <div className={styles.footerContainer}>
                <div className={styles.footerTop}>
                    ...
                    <div className={styles.linksSection}>
                        ...
                        <div className={styles.linkColumn}>
                            ...
                            <ul className={styles.linkList}>
                                <li><Link href="/legals/terms-and-conditions">TERMS</Link></li>
                                <li><Link href="/legals/privacy-policy">PRIVACY</Link></li>
                                <li><Link href="/legals/refund-policy">REFUNDS</Link></li>
                                <li><Link href="/legals/license">LICENSE</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className={styles.linkColumn}>
                            <div>
                                ...
                                <ul className={styles.linkList}>
                                    <li><span onClick={handleDiscordCopy} style={{ cursor: 'pointer' }}>{discordCopied ? 'Copied!' : 'xKnighty'}</span></li>
                                </ul>
                            </div>
                            <div>
                ...
                <div className={styles.footerBottom}>
                    <p className={styles.copyright}>© {new Date().getFullYear()} KnightyBuilds</p>
